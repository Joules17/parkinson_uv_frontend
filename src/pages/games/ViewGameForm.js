...
// mui 
import { Grid, TextField, Typography, List, ListItemAvatar, ListItemButton, ListItemText, Avatar, Box, FormControlLabel, FormGroup, Checkbox, FormControl, Alert, Button } from '@mui/material';
        ...
        <MainCard content={false}>
            <Grid item xs={12} >
                <Grid container spacing={2} sx={{ justifyContent: 'center' }}>
                    ...
                    {(card.title === 'Atrapa el ratón' || card.title === 'Caos Simetrico') && (
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                            <TextField
                                type="number"
                                label="Niveles"
