...
// Dashboard Patient
const DashboardPatient = ({ reports, activity_stats, user }) => {
        ...
        <Grid container rowSpacing={4.5} columnSpacing={2.75}>
            ...
            <Grid item xs={12} sx={{ mb: -2.25, textAlign: 'center' }}>
                <Typography variant="h3">
                    Bienvenido paciente {user.name} {user.lastname}, ¿Qué desea hacer el día de hoy?{' '}
                </Typography>
            </Grid>
            <Grid item xs={12} mb={2}>
                <MenuDashboard type={2} />
            </Grid>
            ...
            {reports.length === 0 ? (
                <Grid item xs={12} sx={{ mb: -2.25, textAlign: 'center' }}>
                    ...
                    <Typography variant="h4" mb={1}>
                        Parece que no tienes resultados aún, en cuanto realices actividades podrás ver estadísticas y resultados aquí
                    </Typography>
                </Grid>
            ) : (
                <>
