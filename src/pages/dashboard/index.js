...
const DashboardDefault = () => {
    ...
    // api request 
    const { GetReportsByTherapistDetailed } = useReportResponse();
    ...
    console.log(reports)
    if (tipo === null || user_id === null || reports === undefined || userInfo === null) {
        return (
            <ChargingCard />
        )
    } else if (tipo === '1') {
        return (
            <DashboardDoctor reports = {reports} user = {userInfo}/>
        )
    } else {
