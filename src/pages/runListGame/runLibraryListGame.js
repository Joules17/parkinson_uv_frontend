...
const RunLibraryListGames = () => {
    ...
    const renderGame = () => {
        switch (startGame.title) {
            case "Objeto Intruso":
                return <ObjectIntruder setting={startGame.setting} id={startGame.id} fromActivity={false} />;
            case "Encuentra el número":
                return <GameNumbers setting={startGame.setting} id={startGame.id} fromActivity={false} />;
            case "Flechas Articas":
                return <GameArtic setting={startGame.setting} id={startGame.id} fromActivity={false} />;
            case "Recuerda y Encuentra":
                return <GameRememberAndFind setting={startGame.setting} id={startGame.id} fromActivity={false} />;
            case "Letras VS Numeros":
                return <LettersVsNumbers setting={startGame.setting} id={startGame.id} fromActivity={false} />;
            case "Palabras Ocultas":
                return <GameLetras setting={startGame.setting} id={startGame.id} fromActivity={false} />;
            case "Flechas Congeladas":
                return <GameFlechasCongeladas setting={startGame.setting} id={startGame.id} fromActivity={false} />;
            case "Letras Marinas":
                return <GameLetrasMarinas setting={startGame.setting} id={startGame.id} fromActivity={false} />;
            case "Burbujas de Memoria":
                return <GameMemoryBubbles setting={startGame.setting} id={startGame.id} fromActivity={false} />;
            case "Fotografias Misteriosas":
                return <GameFotografias setting={startGame.setting} id={startGame.id} fromActivity={false} />;
            case "Cuadrilla de Letras y Numeros":
                return <GameCuadrilla setting={startGame.setting} id={startGame.id} fromActivity={false} />;
            case "La hora del té":
                return <GameTe setting={startGame.setting} id={startGame.id} fromActivity={false} />;
            case "Fiesta de Burbujas":
                return <GameBubbleParty setting={startGame.setting} id={startGame.id} fromActivity={false} />;
            default:
                return null;
        }
    };
...
export default RunLibraryListGames;