...
export default class CuadrillaInit extends Phaser.Scene {
    constructor () {
        super({key: 'CuadrillaInit', backgroundColor: '#3f1651'});
    }
    ...
    pass () {
        ...
        this.scene.start('CuadrillaMenu', {settings}, {game: this.game})
    }
}