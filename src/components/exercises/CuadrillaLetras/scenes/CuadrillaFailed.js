...
export default class CuadrillaFailed extends Phaser.Scene {
    constructor () {
        super ({ key: 'CuadrillaFailed', backgroundColor: '#3f1651' });
    ...
    create () {
        ...
        this.button_message.on('pointerdown', () => {
            ...
            this.scene.start('CuadrillaInit', {setting: settings }, { game: this.game }); 
        });
