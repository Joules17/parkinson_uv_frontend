...
export default class BubblePartyFailed extends Phaser.Scene {
    constructor () {
        super({ key: 'BubblePartyFailed', backgroundColor: '#3f1651' });
    ...
    create () {
        ...
        this.button_message.on('pointerdown', () => {
            ...
            this.scene.start('BubblePartyInit', { setting: settings }, { game: this.game });
        }); 
