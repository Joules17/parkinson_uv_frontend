...
export default class FlechasFailed extends Phaser.Scene {
    constructor () {
        super({key: 'FlechasFailed', backgroundColor: '#3f1651'});
    ...
    create () {
        ...
        this.button_message.on('pointerdown', () => {
            ...
            this.scene.start('FlechasInit', { setting: settings }, { game: this.game });
        }); 
