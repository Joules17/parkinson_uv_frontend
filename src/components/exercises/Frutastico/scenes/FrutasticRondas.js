...
export default class FrutasticRondas extends Phaser.Scene {
  ...
  create() {
    ...
    // text 
    this.text_numberrondas = this.add.text(120,540, "Rondas: " + this.current_number + "/" + this.number_rounds, { fontFamily : 'ARCO', fill: '#000000'}).setFontSize(25)
    this.texto_tiempototal = this.add.text(21,538, this.gameTimeMin +' : '+ this.gameTimeSec, { fontFamily : 'ARCO', fill: '#000000'}).setFontSize(25)
    this.texto_errores = this.add.text(350, 540, "ERRORES: " + this.number_errors, { fontFamily : 'ARCO', fill: '#000000'}).setFontSize(25)
